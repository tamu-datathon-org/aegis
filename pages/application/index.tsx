...
function Home(): JSX.Element {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>, setToast: any) => {
        ...
        const fieldsToValidate = [{variable: firstName, label: 'First Name'}, {
            variable: lastName,
            label: 'Last Name'
        }, {variable: age, label: 'Age'}, {variable: country, label: 'Country'}, {
            variable: school,
            label: 'School'
        ...
        if (!liabilityTerms) missingFields.push("TAMU Datathon Talent Release and Liability Terms");
